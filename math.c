...
// O3 constant folding my man
poly_cubic_t bezier2d_to_poly_cubic(const bezier2d_t* b) {
    const float p0x = b->p0.x, p0y = b->p0.y;
    const float p1x = b->p1.x, p1y = b->p1.y;
    const float p2x = b->p2.x, p2y = b->p2.y;
    const float p3x = b->p3.x, p3y = b->p3.y;

    const float denom = p0x*p0x*p0x*p0x*p2x - p0x*p0x*p0x*p0x*p3x - p0x*p0x*p0x*p1x*p2x + p0x*p0x*p0x*p1x*p3x - 3*p0x*p0x*p0x*p2x*p3x + 3*p0x*p0x*p0x*p3x*p3x + 3*p0x*p0x*p1x*p2x*p3x - 3*p0x*p0x*p1x*p3x*p3x + 3*p0x*p0x*p2x*p3x*p3x - 3*p0x*p0x*p3x*p3x*p3x - 3*p0x*p1x*p2x*p3x*p3x + 3*p0x*p1x*p3x*p3x*p3x - p0x*p2x*p3x*p3x*p3x + p0x*p3x*p3x*p3x*p3x + p1x*p2x*p3x*p3x*p3x - p1x*p3x*p3x*p3x*p3x;

    return (poly_cubic_t) {
        .a = (p0x*p0x*p0x*p0x*p2x*p3y - p0x*p0x*p0x*p0x*p2y*p3x - p0x*p0x*p0x*p1x*p2x*p3y + p0x*p0x*p0x*p1x*p2y*p3x - 3*p0x*p0x*p0x*p2x*p3x*p3y + p0x*p0x*p0x*p2y*p3x*p3x + 2*p0x*p0x*p0x*p3x*p3x*p3y + 2*p0x*p0x*p0y*p2x*p3x*p3x - 2*p0x*p0x*p0y*p3x*p3x*p3x + 3*p0x*p0x*p1x*p2x*p3x*p3y - p0x*p0x*p1x*p2y*p3x*p3x - 2*p0x*p0x*p1x*p3x*p3x*p3y + p0x*p0x*p1y*p2x*p3x*p3x - p0x*p0x*p1y*p3x*p3x*p3x - 3*p0x*p0y*p1x*p2x*p3x*p3x + 3*p0x*p0y*p1x*p3x*p3x*p3x - p0x*p1y*p2x*p3x*p3x*p3x + p0x*p1y*p3x*p3x*p3x*p3x + p0y*p1x*p2x*p3x*p3x*p3x - p0y*p1x*p3x*p3x*p3x*p3x)/denom,
        .b = (p0x*p0x*p0x*p0x*p2y - p0x*p0x*p0x*p0x*p3y - p0x*p0x*p0x*p1x*p2y + p0x*p0x*p0x*p1x*p3y + p0x*p0x*p0x*p2y*p3x - p0x*p0x*p0x*p3x*p3y - 4*p0x*p0x*p0y*p2x*p3x + 4*p0x*p0x*p0y*p3x*p3x - p0x*p0x*p1x*p2y*p3x + p0x*p0x*p1x*p3x*p3y - 2*p0x*p0x*p1y*p2x*p3x + 2*p0x*p0x*p1y*p3x*p3x + 6*p0x*p0x*p2x*p3x*p3y - 2*p0x*p0x*p2y*p3x*p3x - 4*p0x*p0x*p3x*p3x*p3y + 6*p0x*p0y*p1x*p2x*p3x - 6*p0x*p0y*p1x*p3x*p3x - p0x*p0y*p2x*p3x*p3x + p0x*p0y*p3x*p3x*p3x - 6*p0x*p1x*p2x*p3x*p3y + 2*p0x*p1x*p2y*p3x*p3x + 4*p0x*p1x*p3x*p3x*p3y + p0x*p1y*p2x*p3x*p3x - p0x*p1y*p3x*p3x*p3x - p0y*p2x*p3x*p3x*p3x + p0y*p3x*p3x*p3x*p3x + p1y*p2x*p3x*p3x*p3x - p1y*p3x*p3x*p3x*p3x)/denom,
        .c = (-2*p0x*p0x*p0x*p2y + 2*p0x*p0x*p0x*p3y + 2*p0x*p0x*p0y*p2x - 2*p0x*p0x*p0y*p3x + 2*p0x*p0x*p1x*p2y - 2*p0x*p0x*p1x*p3y + p0x*p0x*p1y*p2x - p0x*p0x*p1y*p3x - 3*p0x*p0x*p2x*p3y + p0x*p0x*p2y*p3x + 2*p0x*p0x*p3x*p3y - 3*p0x*p0y*p1x*p2x + 3*p0x*p0y*p1x*p3x + 2*p0x*p0y*p2x*p3x - 2*p0x*p0y*p3x*p3x + 3*p0x*p1x*p2x*p3y - p0x*p1x*p2y*p3x - 2*p0x*p1x*p3x*p3y + p0x*p1y*p2x*p3x - p0x*p1y*p3x*p3x - 3*p0x*p2x*p3x*p3y + p0x*p2y*p3x*p3x + 2*p0x*p3x*p3x*p3y - 3*p0y*p1x*p2x*p3x + 3*p0y*p1x*p3x*p3x + 2*p0y*p2x*p3x*p3x - 2*p0y*p3x*p3x*p3x + 3*p1x*p2x*p3x*p3y - p1x*p2y*p3x*p3x - 2*p1x*p3x*p3x*p3y - 2*p1y*p2x*p3x*p3x + 2*p1y*p3x*p3x*p3x)/denom,
        .d = (p0x*p0x*p2y - p0x*p0x*p3y - p0x*p0y*p2x + p0x*p0y*p3x - p0x*p1x*p2y + p0x*p1x*p3y - p0x*p1y*p2x + p0x*p1y*p3x + 2*p0x*p2x*p3y - p0x*p2y*p3x - p0x*p3x*p3y + 2*p0y*p1x*p2x - 2*p0y*p1x*p3x - p0y*p2x*p3x + p0y*p3x*p3x - 2*p1x*p2x*p3y + p1x*p2y*p3x + p1x*p3x*p3y + p1y*p2x*p3x - p1y*p3x*p3x)/denom,
    };
}
